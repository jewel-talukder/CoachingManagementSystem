    ...
    <div className="px-4 py-6 sm:px-0">
      ...
      <div className="mb-4 flex gap-2">
        <button
          ...
          className={`px-4 py-2 rounded-md text-sm font-medium ${filterActive === null
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md text-sm font-medium ${filterActive === true
            ? 'bg-blue-600 text-white'
            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md text-sm font-medium ${filterActive === false
            ? 'bg-blue-600 text-white'
            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
            }`}
        >
                ...
                <div className="px-4 py-4 sm:px-6 hover:bg-gray-50">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                      <span
                        className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${specialization.isActive
