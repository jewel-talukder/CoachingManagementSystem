      ...
      <div className="mb-4">
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 px-3 py-2 border"
          />
        </div>
      </div>
                ...
                <form onSubmit={handlePaymentSubmit} className="space-y-6">
                  ...
                  <div className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 space-y-5">
                    <div>
                      ...
                      <select
                        ...
                        className="block w-full border border-gray-200 rounded-xl py-3 px-4 text-sm font-semibold focus:ring-4 focus:ring-blue-100 focus:border-blue-500 bg-white shadow-sm transition-all shadow-sm transition-all"
                      >
                    ...
                    <div className="grid grid-cols-2 gap-5">
                      <div>
                        ...
                        <div className="relative group">
                          <input
                            ...
                            className="block w-full pl-11 pr-4 border border-gray-200 rounded-xl py-3.5 focus:ring-4 focus:ring-blue-100 focus:border-blue-500 text-lg font-bold text-gray-900 shadow-sm transition-all group-hover:border-gray-300 shadow-sm transition-all group-hover:border-gray-300"
                            placeholder="0.00"
                          />
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="block w-full border border-gray-200 rounded-xl py-3.5 px-4 focus:ring-4 focus:ring-blue-100 focus:border-blue-500 text-sm font-bold bg-white shadow-sm shadow-sm"
                        >
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm font-medium focus:ring-4 focus:ring-blue-100 focus:border-blue-500 placeholder-gray-300 bg-white shadow-sm transition-all shadow-sm transition-all"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="block w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm font-medium focus:ring-4 focus:ring-blue-100 focus:border-blue-500 placeholder-gray-300 bg-white resize-none shadow-sm transition-all shadow-sm transition-all"
                  ...
                  <div className="mt-10 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-4 space-y-reverse space-y-3 sm:space-y-0 pt-8 border-t border-gray-100">
                    <button
                      type="button"
                      onClick={() => setShowPaymentModal(false)}
                      className="inline-flex justify-center items-center px-8 py-3.5 border border-gray-200 shadow-sm text-sm font-bold rounded-xl text-gray-600 bg-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-100 transition-all hover:border-gray-300 shadow-sm transition-all hover:border-gray-300"
                    >
                      Dismiss
                    </button>
                    <button
                      type="submit"
                      disabled={submitting}
                      className="inline-flex justify-center items-center px-10 py-3.5 border border-transparent shadow-[0_10px_30px_rgba(37,99,235,0.3)] text-base font-black rounded-xl text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 transition-all transform active:scale-95 disabled:opacity-50 shadow-lg"
                    >
                      {submitting ? (
                        <>
